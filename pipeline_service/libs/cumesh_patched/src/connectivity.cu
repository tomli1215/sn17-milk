...
void CuMesh::get_vertex_face_adjacency() {
    ...
    {
        this->temp_storage.resize(this->vert2face.size * sizeof(int));
        size_t sort_temp_bytes = 0;
        CUDA_CHECK(cub::DeviceSegmentedSort::SortKeys(
            nullptr, sort_temp_bytes,
            this->vert2face.ptr,
            reinterpret_cast<int*>(this->temp_storage.ptr),
            (int)this->vert2face.size,
            (int)V,
            this->vert2face_offset.ptr,
            this->vert2face_offset.ptr + 1
        ));
        ...
        swap_buffers(this->temp_storage, this->vert2face);
    }
}
